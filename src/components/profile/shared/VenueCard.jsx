...
export default function VenueCard({
  ...
  // Unngå navigasjon hvis man klikker på action/booking/cancel-knapp
        ...
        <div>
          ...
          <div className="flex items-center gap-4 mb-3 flex-wrap">
            <div
              ...
              title={`Max guests: ${maxGuests}`}
            >
              <span className="material-symbols-outlined text-lg text-purple-700">
                king_bed
              </span>
            ...
            {bookingCount === 0 ? (
              ...
              venue.bookings.map(b => (
                ...
                >
                  ...
                  <button
                    type="button"
                    className="cancel-btn px-3 py-1 rounded bg-red-50 text-red-600 text-xs hover:bg-red-100 whitespace-nowrap"
                    onClick={e => {
                      e.stopPropagation();
                      if (onRequestCancelBooking) onRequestCancelBooking(b.id);
                    }}
                  >
                    Cancel
                  </button>
