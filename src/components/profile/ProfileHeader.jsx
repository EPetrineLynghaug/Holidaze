...
export default function ProfileHeader({ user }) {
  ...
  return (
    <header className="mb-8">
      {/* Banner – fyller bredden, bruker faste px‑høyder */}
      <section className="w-full object-cover " aria-labelledby="banner-heading">
  ...
  {/* Wrapp bildet slik at <span> kan forankres til det */}
  <div className="relative">
    ...
    <span className="absolute -bottom-2 left-1/2 -translate-x-1/2 px-2 py-0.5 text-white rounded-full uppercase text-xs tracking-wider"
