    ...
    <section className="p-12 mt-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-10 mb-12">
        ...
        <div className="flex justify-center md:justify-end">
          <picture>
            {/* Prøv WebP først */}
            <source srcSet="/images/venue.webp" type="image/webp" />
            {/* Fallback til PNG om WebP ikke støttes */}
            <img
        ...
        <div className="text-center md:text-left max-w-sm mx-auto md:mx-0 flex flex-col justify-center md:h-80">
          <blockquote className="relative italic text-gray-800 text-[18px] leading-relaxed px-2 max-w-[26ch]">
            <span className="absolute -top-4 -left-4 text-3xl text-gray-300">
              ❝
            </span>
            ...
            <span className="absolute bottom-3 right-1 text-2xl text-gray-300">
              ❞
            </span>
          </blockquote>
